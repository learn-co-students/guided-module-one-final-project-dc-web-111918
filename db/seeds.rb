...
##events
event1 = Event.find_or_create_by(museum: airandspacemuseum, neighborhood: smithsonianeast, name:"Special Exhibition1", date_time: "2018-12-04 18:00:00", eventtype: "Special Exhibition", duration: "60", description: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit")
event2 = Event.find_or_create_by(museum: naturalhistory, neighborhood: smithsonianwest, name:"Special Exhibition2", date_time: "2018-12-04 13:00:00", eventtype: "Special Exhibition", duration: "180", description: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit")
...
event5 = Event.find_or_create_by(museum: naturalhistory, neighborhood: smithsonianwest, name:"Air and Space Museum", date_time: "2018-12-04 09:00:00", eventtype: "Museum", duration: "480", description: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit")
event6 = Event.find_or_create_by(museum: airandspacemuseum, neighborhood: smithsonianeast, name:"National Gallery", date_time: "2018-12-04 09:00:00", eventtype: "Museum", duration: "480", description: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit")
...
event9 = Event.find_or_create_by(museum: naturalhistory, neighborhood: smithsonianwest, name:"Lecture1", date_time: "2018-12-04 14:00:00", eventtype: "Lecture", duration: "60", description: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit")
event10 = Event.find_or_create_by(museum: airandspacemuseum, neighborhood: smithsonianeast, name:"Lecture2", date_time: "2018-12-04 15:00:00", eventtype: "Lecture", duration: "90", description: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit")
...
event13 = Event.find_or_create_by(museum: naturalhistory, neighborhood: smithsonianwest, name:"Concert1", date_time: "2018-12-04 16:00:00", eventtype: "Lecture", duration: "120", description: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit")
event14 = Event.find_or_create_by(museum: airandspacemuseum, neighborhood: smithsonianeast, name:"Concert2", date_time: "2018-12-04 17:00:00", eventtype: "Lecture", duration: "60", description: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit")
